...
public class MPGenerator {
    ...
    public static void main(String[] args) {
        ...
        gc.setAuthor("hank.huang");
        gc.setOpen(false);
        mpg.setGlobalConfig(gc);

        // 数据源配置
        DataSourceConfig dsc = new DataSourceConfig();
        dsc.setUrl("jdbc:mysql://10.100.62.112:3306/checkin?autoReconnect=true&useAffectedRows=true&allowMultiQueries=true&characterEncoding=UTF-8");
        ...
        pc.setParent("us.zoom");//你哪个父目录下创建包
